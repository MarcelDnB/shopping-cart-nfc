...
public class telegramMain extends AbstractVerticle {
	...
	public void start(Promise<Void> future) {
		...
		bot = TelegramBot.create(vertx, telegramOptions).receiver(new LongPollingReceiver().onUpdate(handler -> {
			if (handler.getMessage().getText().toLowerCase().contains("/hola")) {
				 ...
				 * para saber que nos encontramos en esta seccion (de a�adir a la base de
				...
				/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
				 * El usuario indica que quiere ver cierta informaci�n de la base de datos,
				 ...
				 * mediante el cual el bot de Telegram le va a hacer un cuestionario que lo guiar� para hacer
				 * tal modificacion.
				 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
				 ...
				 * que eliminar de otras tablas no tendr�a sentido por ahora.
				 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
				...
				/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
				 * Parte del codigo dedicada a la llamada de eliminar la opci�n a, que pertenece a producto
				 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			 ...
			 * dicha variable para guardar el rastro de la opci�n que hemos elegido, en este caso a,b o c
			 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			
			
			/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
			 * Se van a ver los productos escaneados y la cantidad de �stos filtrados por cierta intolerancia,
			 * es decir, vamos a poder ver el inter�s del usuario con cierta intolerancia hacia ciertos
			 * productos. 
			 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			}else if ((handler.getMessage().getText().toLowerCase().contentEquals("a")
				...
				/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
				 * Introduciendo una palabra clave nos devolver� todos los productos que contengan dicha palabra,
				 * por lo que ser� util por ejemplo para ver si ya existe cierto producto en la base de datos.
				 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			}else if((handler.getMessage().getText().toLowerCase().contentEquals("b")
					&& (seccion.get(Integer.parseInt(handler.getMessage().getChatId())) == "/info"))
					|| (seccion.get(Integer.parseInt(handler.getMessage().getChatId())) == "/info"
				...
				/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
				 * Se obtiene el fabricante y numero de tel�fono de �ste introduciendo el ID de producto
				 * correspondiente.
				 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
			}else if((handler.getMessage().getText().toLowerCase().contentEquals("c")
					&& (seccion.get(Integer.parseInt(handler.getMessage().getChatId())) == "/info"))
	...
	void info(Update handler) {
		bot.sendMessage(new SendMessage()
				.setText("A continuaci�n se indica la informaci�n disponible: \n"
						+ " a. Productos escaneados por ususarios con cierta intolerancia" + "\n" +
						"Seleccione la petici�n deseada, introduciendo su �ndice:"+ "\n" + 
						"b. Comprobar si un producto est� en la base de datos\n" + 
						"c. Ver el nombre y numero de tel�fono del fabricante de un producto\n")
				.setChatId(handler.getMessage().getChatId()));
	...
	void modificar(Update handler) {
		bot.sendMessage(new SendMessage()
				.setText("�Qu� tabla desea modificar?\n\n"
						+ "a. Producto\nb. Ingrediente\nc. Intolerancia")
				.setChatId(handler.getMessage().getChatId()));
	...
	void eliminar(Update handler) {
		bot.sendMessage(new SendMessage()
				.setText("�De qu� tabla desea eliminar?\n\n"
						+ "a. Producto\n")
				.setChatId(handler.getMessage().getChatId()));
		...
		if((handler.getMessage().getText().toLowerCase().contentEquals("a")
			...
			bot.sendMessage(new SendMessage()
					.setText("�De que intolerancia desea ver los productos escaneados por los usuarios?, alguno"
							+ " de los ID's mostrados a continuaci�n: " + "\n")
					.setChatId(handler.getMessage().getChatId()));
